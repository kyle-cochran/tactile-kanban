...
class Config:
    ...
    # Path to the YAML file describing the physical NFC sensor topology
    sensor_topology_path: str = field(
        default_factory=lambda: os.environ.get("SENSOR_TOPOLOGY_PATH", "sensors.yaml")
    )
